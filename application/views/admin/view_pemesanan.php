        ...
        <div class="card card-accent-success">
          <div class="card-header">
            <h3>  Kelola Pemesanan </h3>
             <a href="<?php echo base_url('c_pemesanan/input_pemesanan')?>" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"> </i> tambah data </a>
          </div>
          <div class="card-body">
            ...
            <div>
              ...
              <table id="dataCustomer" class="table ">
                ...
                <tbody>
                  ...
                  <td>Syifa</td>
                  <td>1 April 2021</td>
                  <td>Konsultasi, Treatment Wajah</td>
                  <td>
                  ...
                  <td>50000 </td>
                  <td>
                  <button type="button" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></i></button>
