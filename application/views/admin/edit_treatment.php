              ...
              <div class="col-md-9">              
                ...
                <div class="panel-body">
                  <div class="form-horizontal">
                    <form action="<?php echo base_url(). 'c_kelola_treatment/updateTreatment/'.$detail->id; ?>" enctype="multipart/form-data" method="post">
                      ...
                      <div class="row">
                        <div class="col-md-6">                       
                          <div class="form-group">
                            ...
                            <div class="">
                              <input class="form-control" type="text" name="nama_treatment" value="<?php echo $detail->nama_treatment ;?>" required>
                            </div>
                          </div>
